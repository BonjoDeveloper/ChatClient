 ...
 * @since
 * @return
 * Important: if Messenger cannot find the server then adjust firewall to give it network access.
 * Feature: 
...
// * ChatFrame.java is the main class in ChatClient project to handle connections and messages.
// * If you open projects in netbeans
// * then it should ask you for main class
// * and you can set the respective classes as main.

// * To run jClient over different network requires jServer to on a machine
// * that has its own global IP address such as a web host.
// * There is nothing in application itself changing which might enable inter-network support

// * As for sign out you can simply close your client
// * or send the message ".bye" which will lead to ServerSocket disconnecting you.
package com.shu.ui;
...
import com.shu.socket.Message;
import com.shu.socket.SocketClient;
